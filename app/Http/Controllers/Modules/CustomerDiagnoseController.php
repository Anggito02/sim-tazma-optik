...
use App\Services\Modules\CustomerDiagnose\GetCustomerDiagnoseService;
...
class CustomerDiagnoseController extends Controller
{
    ...
    public function __construct(
        ...
        private GetCustomerDiagnoseService $getCustomerDiagnoseService,
    ...
    public function getCustomerDiagnose(Request $request) {
        try {
            $customerDiagnoseDTO = $this->getCustomerDiagnoseService->getCustomerDiagnose($request);
