...
class CustomerDiagnoseInfoDTO {
    ...
    public function setCustomerNamaDepan(string $customer_nama_depan): void {
        $this->customer_nama_depan = $customer_nama_depan;
    }

    public function setCustomerNamaBelakang(string $customer_nama_belakang): void {
        $this->customer_nama_belakang = $customer_nama_belakang;
    }

    public function setCustomerNomorTelepon(string $customer_nomor_telepon): void {
        $this->customer_nomor_telepon = $customer_nomor_telepon;
    }
